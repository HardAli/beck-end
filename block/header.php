<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  <h5 class="my-0 mr-md-auto font-weight-normal">Alli company</h5>
  <nav class="my-2 my-md-0 mr-md-3">
    ...
    <?php
    if ($_COOKIE['login'] != '') {
      print '<a class="p-2 text-dark" href="/article.php">Добавить статью</a>';
    }
     ?>
  ...
  <?php
   ...
   ?>
   <a class="btn btn-outline-primary mr-2" href="/polz.php">Список пользователей</a>
